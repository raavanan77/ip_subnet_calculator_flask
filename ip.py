        ...
        if len(ip_l) == 4 : 
            if int(cidr) < 33 and int(cidr) > 7:
                ...
                for y in range(msb):
                    ...
                    everything += f'|{rangenid[0].center(15)}|{rangenid[1].center(15)}-{end_range_host.center(15)}|{bb_cast.center(15)}|'
